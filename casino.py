...
while ContinueLaPartie==True:
  ...
  try:
    ...
    while NbrMise<0 or NbrMise>49 :
      ...
      try:
        ...
        if NbrMise<=0:
            print("Erreur!ce nombre est null ou negatif , vous devez saisir un nombre strictement  positif:")
        if NbrMise>49:
            print("Erreur!ce nombre est superieur à 49 , vous devez saisir un nombre inferieur ou egale à 49 :")
  mise=0
  while mise<0 or mise>argent:
    ...
    try:
      ...
      print("Erreur , saisie un nombre s'il vous plait :")
    else:
      if mise==0:
          ContinueLaPartie=False
      if mise<=0:
        print("Erreur,la mise que vous tapez est nul ou negative vous devez saisir un nombre positive :")
      if mise>argent :
        print("Erreur,vous n'avez pas cette somme ")
  ...
  if ng==NbrMise :
         argent=mise*3
         print("Felicitation ,vous avez obtenez {} $ ".format(argent))
  elif ng%2==NbrMise%2:
         argent=mise*(0.5)
         print("vous avez misez la bonne couleur , vou avez obtenez {} $".format(argent))
  else:
         print("oups , vous perdez tout votre argent  ")
  if argent==0:
      print("c'est la fin ")
      ContinueLaPartie=False
  print("1-voulez vous quittez le jeux")
  print("2-voulez vous continue")
  quitter=input("donner votre choix : ")
  quitter=int(quitter)
  if quitter==1:
        ContinueLaPartie=False